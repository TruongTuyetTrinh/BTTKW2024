...
def generate_nhanvien_data(n):
    ...
    for i in range(1, n+1):
        ...
        nhanvien_data.append(insert_statement)

    return nhanvien_data

# Generate 1000 records for the NhanVien table
generated_data = generate_nhanvien_data(1000)


# You can save the generated SQL data to a file if needed
...
(
    ...
    -- Điều kiện CHECK cho MaNV theo mẫu 'Nv0xx'
    CONSTRAINT CK_MaNV CHECK (MaNV LIKE 'Nv0%'),

    -- Điều kiện CHECK cho độ tuổi, không hỗ trợ DATEDIFF trong SQLite
    -- Bạn có thể cần thực hiện kiểm tra logic này trong mã ứng dụng hoặc loại bỏ điều kiện này
...
with open('nhanvien_data.sql', 'r', encoding='utf-8') as file:
